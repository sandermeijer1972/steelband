...
function makeWhoPage() {
    ...
    newArticle.classList.add('wiezijnwij');
    const newTitle = document.createElement('div');
    newTitle.classList.add('wiezijnwij__title');
    newTitle.innerText = "Wie zijn wij?";
    newArticle.appendChild(newTitle);
    const firstText = document.createElement('section');
    firstText.classList.add('wiezijnwij__section');
    firstText.innerText = wieData[0];
    newArticle.appendChild(firstText);
    const newImg = document.createElement('img');
    newImg.src = "./images/wie-groep.jpg";
    newArticle.appendChild(newImg);
    const secText = document.createElement('section');
    secText.classList.add('wiezijnwij__section');
    secText.innerText = wieData[1];
    newArticle.appendChild(secText);
    const secImg = document.createElement('img');
    secImg.src = "./images/wie-original.jpg";
    newArticle.appendChild(secImg);
    const thirdText = document.createElement('section');
    thirdText.classList.add('wiezijnwij__section');
    thirdText.innerText = wieData[2];
    newArticle.appendChild(thirdText);
    const newDiv = document.createElement('div');
    newDiv.classList.add('wiezijnwij__photos');
    const thirdImg = document.createElement('img');
    thirdImg.src = "./images/wie-loop.jpg";
    newDiv.appendChild(thirdImg);
    const fourthImg = document.createElement('img');
    fourthImg.src = "./images/wie-kar.jpg";
    newDiv.appendChild(fourthImg);
